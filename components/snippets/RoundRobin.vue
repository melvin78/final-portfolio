...
<div>
  ...
  <p class="ml-5">
    ...
    The two entities are related using this field. We use the <code>AssignAgentToUser()</code> method to do this. Its logic
    ...
    method will essentialy run this query <code>UPDATE Ticket_Table SET CareTaker= agentId where TicketNo = ticketNo;</code>
    ...
    class it will no longer return a result set since the caretaker column will no longer be null.
  </p>
</div>
</template>
